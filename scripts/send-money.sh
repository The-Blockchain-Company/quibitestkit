...
#
#  Tutorials can be found here: https://tbco.zendesk.com/hc/en-us/categories/360002383814-Sophie-Networked-Testnet
...
if [ $# -ne 4 ]; then
  ...
  echo "    <AMOUNT>      Amount to be sent (in entropic) - tx fees will be paid by the source address"
